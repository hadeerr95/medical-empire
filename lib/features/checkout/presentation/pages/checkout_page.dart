                  ...
                  child: Column(
                    children: [
                      ...
                      if (state is! CreateCheckoutLoading)
                        MyButton(
                          voidCallback: () {
                            addresses == 0 ? saveAddress():
                            updateAddress(MainCubit.get(context).checkoutModel!.data.shippingAddresses![_selectedAddressSubject.value].id);
